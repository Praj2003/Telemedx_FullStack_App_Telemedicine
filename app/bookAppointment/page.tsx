          ...
          {filteredOutput.map((doctor) => {
            return (
              ...
              >
                ...
                <div className="flex items-center justify-center">
                  <motion.button onClick={() => handleBook(doctor.name)} whileHover={{scale:1.1, backgroundColor:"teal", color:"white"}} className="bg-black p-3 text-white rounded-xl cursor-pointer">
                    Book Now
                  </motion.button>
                </div>
              </div>
